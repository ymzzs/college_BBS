...
@WebServlet(name = "PageMajorServlet", urlPatterns = {"/PageMajorServlet"})
public class PageMajorServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PageBean<QuestionBean> pageBean = questionService.getQuestionByPageAndSolvedAndMajor(Integer.parseInt(page),solved,major);
